// =================================================================================================
// Photoreal HDR Color Grader (V6.0.4 - Non-Riemannian Geodesic Spectral Edition)
// =================================================================================================
//
...
technique PhotorealHDR_Mastering_V604 <
    ui_label = "Photoreal HDR V6.0.4 (Non-Riemannian Geodesic Spectral Edition)";
    ui_tooltip = "Reference-grade offline color grading executing the exact mathematics of non-Riemannian color space.\n\n"
                 "V6.0.4 Audited Changes:\n"
                 "  - Completely excised Hybrid Log-Gamma (HLG) support from execution paths.\n"
                 "  - Restored C1 mathematical continuity to the CompressLumaPhysiological shoulder model.\n"
                 "  - Restored chromatically neutral V6.0.3 multiplicative black point logic (guarantees zero gamut footprint variation).\n"
                 "  - Integrated exact, solved roots for sRGB C0-continuous thresholds.\n"
                 "  - Verified compatibility of scRGB Rec. 709 primary representation with Rec. 2020 boundary guards.\n"
                 "  - Replaced compiler-sensitive log10 intrinsic configurations with exact log2 scaling matrices.\n\n"
