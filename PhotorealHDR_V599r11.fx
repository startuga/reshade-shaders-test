// =================================================================================================
// Photoreal HDR Color Grader (V5.9.9-r11 - Non-Riemannian Exact Reference Edition)
// =================================================================================================
//
 ...
 * Signatures and parameters standardized to work with normalized targetPeak values.
 */
float3 ApplyNonRiemannianGeodesicToneMapper(float3 lms, float targetPeak, float compressionStart, float desatStrength, float3 luma_LMS_coeffs, float2 mb_white_static, float whitePt)
{
    ...
    float Y_comp = CompressLumaPhysiological(Y, targetPeakNits, startComp);
...
void PS_PhotorealHDR(VS_Output input, out float4 fragColor : SV_Target)
{
    ...
    else if (iToneMapperMode == 2) // Non-Riemannian Geodesic Tone Mapper (NRG-TM)
    {
        ...
        lms = ApplyNonRiemannianGeodesicToneMapper(lms, targetPeak, fCompressionStart, fDesaturationStrength, input.luma_LMS_coeffs, mb_white, whitePt);
...
technique PhotorealHDR_Mastering_V599r11 <
    ui_label = "Photoreal HDR V5.9.9-r11 (Non-Riemannian Exact Reference Edition)";
