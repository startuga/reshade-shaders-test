 ...
 * 
 * Updated for better numerical accuracy with Kahan summation in the bilateral filter loops to minimize floating-point errors,
 * especially beneficial for larger radii and high-precision requirements in HDR content.
 * 
