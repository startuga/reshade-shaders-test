// =================================================================================================
// Photoreal HDR Color Grader (V6.0.3 - Non-Riemannian Geodesic Spectral Edition)
// =================================================================================================
//
...
void PS_PhotorealHDR(VS_Output input, out float4 fragColor : SV_Target)
{
    ...
    else if (iToneMapperMode == 2) // Non-Riemannian Geodesic Tone Mapper (NRG-TM)
    {
        ...
        // --- UPGRADE 1: Adaptive Naka-Rushton Shoulder Curvature (Auto-H) [1]
        float h;
    ...
    // --- UPGRADE 3: MacLeod-Boynton Purity-Preserving Hue Restoration [1]
...
technique PhotorealHDR_Mastering_V603 <
    ui_label = "Photoreal HDR V6.0.3 (Non-Riemannian Geodesic Spectral Edition)";
    ui_tooltip = "Reference-grade offline color grading executing the exact mathematics of non-Riemannian color space.\n\n"
                 "V6.0.3 Audited Changes:\n"
