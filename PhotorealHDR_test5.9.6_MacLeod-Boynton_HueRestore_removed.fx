// =================================================================================================
// Photoreal HDR Color Grader (V5.9.6 - The Ultimate Director's Cut)
// =================================================================================================
//
...
//        Replaced parabolic toe with C1-smooth floor blend (4x wider toe, 3% default residual).
//        Eliminates transition banding and preserves shadow dither/detail.
...
void PS_PhotorealHDR(float4 vpos : SV_Position, float2 texcoord : TEXCOORD, out float4 fragColor : SV_Target)
{
    ...
    // ---------------------------------------------------------------------------------------------
    // STAGE 2: DEHAZE & BLACK POINT (V5.9.6: C1 smooth floor, no crush)
    // ---------------------------------------------------------------------------------------------
...
technique PhotorealHDR_Mastering_V596 <
    ui_label = "Photoreal HDR V5.9.6 (Director's Cut)";
